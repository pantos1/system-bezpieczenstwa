...
\bibitem{apache-auth}
The Apache Software Foundation, Authentication and Authorization, Dokumentacja serwera HTTP Apache
\url{https://httpd.apache.org/docs/2.4/howto/auth.html}

\bibitem{apache-password}
The Apache Software Foundation, htpasswd - Manage user files for basic authentication, Dokumentacja serwera HTTP Apache
